...
class TranslationWindow:
    ...
    def __init__(
        ...
        *,
        ...
        self._label_original.set_width_chars(1)
        ...
        self._label_translation.set_width_chars(1)
        self._label_translation.set_max_width_chars(self._max_label_chars)
        self._label_translation.set_hexpand(True)
        ...
        self._label_definitions.set_width_chars(1)
        self._label_definitions.set_max_width_chars(self._max_label_chars)
        self._label_definitions.set_hexpand(True)
